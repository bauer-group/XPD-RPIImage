...
* **update:** told a module that could not run apart from one with nothing to do ([665cc0b](https://github.com/bauer-group/XPD-RPIImage/commit/665cc0bdd0141cf3f8f94ab9cf36a1098607bef3))
...
* **banner:** wrapped the variant description to the rule ([c311375](https://github.com/bauer-group/XPD-RPIImage/commit/c31137570ccdd3ae629f5a59387da4aad5ae76e0))

## [0.13.3](https://github.com/bauer-group/XPD-RPIImage/compare/v0.13.2...v0.13.3) (2026-09-10)

### 🐛 Bug Fixes

* **update:** stopped stale payload from defeating every update ([3b53ff0](https://github.com/bauer-group/XPD-RPIImage/commit/3b53ff0433830de7f585b49e6e289b298a8c6bd8))

## [0.13.2](https://github.com/bauer-group/XPD-RPIImage/compare/v0.13.1...v0.13.2) (2026-09-10)

### 🐛 Bug Fixes

* **watchdog:** stopped the two renderers of the same value drifting ([e50f51b](https://github.com/bauer-group/XPD-RPIImage/commit/e50f51bdc3fdeb8bd580a5c400ad07584812b8a5))
...
* **generate:** kept validation notes out of the --json output ([18fc5fb](https://github.com/bauer-group/XPD-RPIImage/commit/18fc5fb2bfd1630c8df826179dcdb5472f4f6679))
...
* **test:** made the update test work for every variant ([c36f153](https://github.com/bauer-group/XPD-RPIImage/commit/c36f1534c6a10d80f4087c65577f8797c425e1b0))
...
* **apply:** made re-applying a release a genuine no-op ([e42e9b0](https://github.com/bauer-group/XPD-RPIImage/commit/e42e9b0503dcf122d24e5ea73fdc1cf27b4a0ca5))
...
* **release:** recorded the identity an in-place update needs ([a80e01b](https://github.com/bauer-group/XPD-RPIImage/commit/a80e01be5709e85889bacbe0f0bf3fab133a5eaa))
* **setup:** added update --self so the helper can replace itself ([00d72fe](https://github.com/bauer-group/XPD-RPIImage/commit/00d72fe57723dc41ed1f9d455df76ed9f84dedb6))
...
* **banner:** surfaced the CAN controller state in the MOTD ([a3f216c](https://github.com/bauer-group/XPD-RPIImage/commit/a3f216c80b74f34f7b891a708c468a1b34749a68))
